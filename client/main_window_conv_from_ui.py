...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Chat Program alpha release"))
        ...
        self.label_new_message.setText(_translate("MainClientWindow", "Enter new message:"))
